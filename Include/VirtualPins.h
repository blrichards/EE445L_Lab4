...
// From Blynk
#define NUM_VIRTUAL_PINS_FROM_BLYNK 4
#define VP_FAR_LEFT_SWITCH 0
#define VP_SECOND_TO_LEFT_SWITCH 1
#define VP_SECOND_TO_RIGHT_SWITCH 2
#define VP_FAR_RIGHT_SWITCH 3
