...
//************* ST7735_Circle********************************************
//  Draws one circle on the ST7735 color LCD
//  Inputs: (x,y) is the center of the circle
//          radius is the length of the radius in pixels
// x is a horizontal position, columns from the left edge
//               must be less than 128
//               0 is on the left, 126 is near the right
